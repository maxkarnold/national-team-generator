...
export class CreatePlayerService {
  ...
  createPlayer(
    ...
    const { nationality, logo } = this.getNation('nationality', rating) || '';
  ...
  getNames(nationality: string) {
    ...
    const {
      ...
      names,
    } = this.afsService.getFirstName(nationality, randomNum);
    ...
    const {
      ...
      names: lastNames,
    } = this.afsService.getLastName(player.nationality, randomNum);
