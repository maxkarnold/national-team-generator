export interface Player {
    ...
    attributes?: any;
    // Attributes will be all the numeric attributes for a player. This will be generated based on the overall rating, position, foot, and other factors. This will most likely be an object with many numeric values.
